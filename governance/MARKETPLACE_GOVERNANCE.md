...
3. Reviewer checks intent, effects, contracts, and evidence.
4. Maintainer indexes accepted entries into `registry/`.
5. Merge publishes the updated read-only library state.
